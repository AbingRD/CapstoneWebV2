                    ...
                    <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 p-6 overflow-y-auto'>
                        {listings && listings.length > 0 && (
                            listings.map(listing => (
                                <div key={listing.id} onClick={() => setSelectedVehicle(listing)} className='cursor-pointer flex flex-col gap-2 border rounded justify-center whitespace-normal p-3 items-center shadow-md'>
