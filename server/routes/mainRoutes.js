...
router.route("/dealership/bankagents").get(verifyRoles(['dealershipManager', 'dealershipAgent']), getDealershipBankAgents)

router.route("/dealership/applications").get(verifyRoles(["dealershipManager", "dealershipAgent", "bankAgent"]), getDealershipListingApplications);
...
router.route("/buyer/listings/apply").post(buyerDocuments, verifyBuyerToken, buyerCreateApplication);
router.route("/buyer/applications").get(verifyRoles(['buyer']), buyerGetListingApplications);

router.route("/user/otp").get(requestOTPCode);
router.route("/buyer/verify").post(verifyAccount, verifyOTP,);

router.route("/agent/application").put(upload.single("certificateOfApproval"), verifyRoles(['dealershipAgent', 'bankAgent']), updateApplication);
router.route("/bankagent/applicants").get(verifyRoles(['bankAgent']), getBankAgentApplicants);
